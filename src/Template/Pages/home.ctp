...
<div class="row">
    <div class="columns large-6">
        ...
        <?php if (version_compare(PHP_VERSION, '7.0.0', '>=')): ?>
            <li class="bullet success">Your version of PHP is 7.0.0 or higher (detected <?= PHP_VERSION ?>).</li>
        <?php else: ?>
            <li class="bullet problem">Your version of PHP is too low. You need PHP 7.0.0 or higher to use CakePHP (detected <?= PHP_VERSION ?>).</li>
        <?php endif; ?>
